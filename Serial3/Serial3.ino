...
QTRSensorsRC side((unsigned char[]) {8,1},2,2500,A3);
...
void loop(){ 
...

  {
    ...
    //detectó por la izquierda cambio de casilla
      break;
    case 'c':
    //detectó cambio de casilla en ambos lados
      break;
    case 'd':
 ...
 int evento(int flanco_comparacion){
  ...
  qtrrc.read(sensorValues);
       ...
       if(   (sensorValues_side[0]>flanco_comparacion)   && !(sensorValues_side[1]>flanco_comparacion) && !(sensorValues_side[1]>flanco_comparacion) && !(sensorValues[4]>flanco_comparacion))      return a;
  else if(  !(sensorValues_side[0]>flanco_comparacion)   &&  (sensorValues_side[1]>flanco_comparacion) && !(sensorValues_side[1]>flanco_comparacion) && !(sensorValues[4]>flanco_comparacion))      return b;
  else if(   (sensorValues_side[0]>flanco_comparacion)   &&  (sensorValues_side[1]>flanco_comparacion) && !(sensorValues_side[1]>flanco_comparacion) && !(sensorValues[4]>flanco_comparacion))      return c;
  else if(   (sensorValues_side[0]>flanco_comparacion)   && !(sensorValues_side[1]>flanco_comparacion) &&  (sensorValues_side[1]>flanco_comparacion) && !(sensorValues[4]>flanco_comparacion))      return d;  
  else if(  !(sensorValues_side[0]>flanco_comparacion)   &&  (sensorValues_side[1]>flanco_comparacion) && !(sensorValues_side[1]>flanco_comparacion) &&  (sensorValues[4]>flanco_comparacion))      return e;
  else if(   (sensorValues_side[0]>flanco_comparacion)   &&  (sensorValues_side[1]>flanco_comparacion) &&  (sensorValues_side[1]>flanco_comparacion) &&  (sensorValues[4]>flanco_comparacion))      return f; 
  else if(  !(sensorValues_side[0]>flanco_comparacion)   && !(sensorValues_side[1]>flanco_comparacion) && !(sensorValues_side[1]>flanco_comparacion) && !(sensorValues[4]>flanco_comparacion))      return g;
  else return 0;
  }
