...
QTRSensorsRC qtrrc((unsigned char[]) {9,8,7,6,5,4,3,2},8,2500,A3);  
...
void loop(){ 
  ...
  switch(evento(700)) //cada evento envía una trama para ser procesada por en processing

  {
    case 'a':
    //toda la qtr sin pared frontal
      break;
    case 'b':
    //detencción inmediata
      break;
    case 'c':
    //derecha únicamente
      break;
    ...
    //izquierda únicamente
      break;
    case 'f':
    //cambio de casilla simple    
      break;
    case 'g':
    //toda la qtr con frontal
      break;
    default :
 ...
 int evento(int flanco_comparacion){
  qtrrc.read(sensorValues);
       ...
       if(   (sensorValues[0]>flanco_comparacion)   && !(sensorValues[1]>flanco_comparacion) && !(sensorValues[6]>flanco_comparacion) &&  (sensorValues[7]>flanco_comparacion))      return 'a';
  else if(   (sensorValues[0]>flanco_comparacion)   && !(sensorValues[1]>flanco_comparacion) && !(sensorValues[3]>flanco_comparacion) && !(sensorValues[6]>flanco_comparacion) &&  (sensorValues[7]>flanco_comparacion))      return 'b';
  else if(  !(sensorValues[0]>flanco_comparacion)   && !(sensorValues[1]>flanco_comparacion) && !(sensorValues[6]>flanco_comparacion) &&  (sensorValues[7]>flanco_comparacion))      return 'c';
  else if(   (sensorValues[0]>flanco_comparacion)   && !(sensorValues[1]>flanco_comparacion) &&  (sensorValues[6]>flanco_comparacion) &&  (sensorValues[7]>flanco_comparacion))      return 'd'; 
  else if(   (sensorValues[0]>flanco_comparacion)   &&  (sensorValues[1]>flanco_comparacion) && !(sensorValues[6]>flanco_comparacion) &&  (sensorValues[7]>flanco_comparacion))      return 'e';
  else if(   (sensorValues[0]>flanco_comparacion)   &&  (sensorValues[1]>flanco_comparacion) &&  (sensorValues[3]>flanco_comparacion) &&  (sensorValues[6]>flanco_comparacion) && (sensorValues[7]>flanco_comparacion))      return 'f';
  else if(   (sensorValues[0]>flanco_comparacion)   &&  (sensorValues[1]>flanco_comparacion) &&  (sensorValues[3]>flanco_comparacion) &&  (sensorValues[6]>flanco_comparacion) && (sensorValues[7]>flanco_comparacion))      return 'g';
...
////////funciones para el control del robot////
 ...
 void pid(int velocidad, float Kp, float Ki, float Kd){
  ...
  proporcional = (pos) - 3500; // set point es 2500, asi obtenemos el error
